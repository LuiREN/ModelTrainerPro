...
class HelpDialog(QDialog):
    ...
    def get_model_usage_help(self) -> str:
        ...
        <h3>1. Тестирование модели в приложении</h3>
    
        <p>Для тестирования обученной модели на новых данных непосредственно в приложении:</p>
    
        <ol>
            <li>Обучите модель или загрузите ранее обученную</li>
            <li>Нажмите кнопку "Тестировать модель" на панели инструментов</li>
            <li>В открывшемся окне тестирования у вас есть два варианта:
                <ul>
                    <li><strong>Загрузка тестовых данных:</strong> нажмите "Загрузить данные" и выберите файл с новыми данными</li>
                    <li><strong>Ручной ввод:</strong> введите значения признаков вручную в соответствующие поля</li>
                </ul>
            </li>
            <li>После ввода данных нажмите "Получить предсказание" для одиночного прогноза или "Сделать предсказания на загруженных данных" для прогноза на всем наборе</li>
            <li>Результаты будут отображены в нижней части окна</li>
            <li>Вы можете экспортировать результаты, нажав кнопку "Экспорт результатов"</li>
        </ol>
